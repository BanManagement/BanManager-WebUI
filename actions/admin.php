...
if(empty($settings['password']) || $settings['password'] == 'password')
	...
	<br />
	<br />
	<h3><?= $language['admin']['misc-header']; ?></h3>
	<a href="index.php?action=deletecache&authid=<?php echo sha1($settings['password']); ?>" class="btn btn-primary"><?= $language['admin']['misc-clear_cache']; ?></a>
	<?php
}
?>
