  ...
  return (
    <div className='relative bg-primary-500'>
      ...
      <RemoveScroll forwardProps enabled={drawerOpen}>
        <aside
          className={clsx('transform top-0 right-0 w-72 bg-gray-800 fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30', RemoveScroll.classNames.zeroRight,
            {
