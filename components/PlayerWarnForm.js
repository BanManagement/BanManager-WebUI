...
export default function PlayerWarnForm ({ player, servers, onFinished, query, parseVariables, disableServers = false, defaults = {} }) {
  ...
  return (
    <Form size='large' onSubmit={onSubmit} error loading={loading}>
      ...
      <Form.Input
        ...
        type='number'
        onChange={async (e, { value }) => {
          setInputState({ ...inputState, points: value })
        }}
