...
const ItemPrev = ({ onPageChange }) => (
  <button onClick={onPageChange} type='button' className='w-full p-4 text-base rounded-l-xl bg-primary-900 hover:bg-primary-400'>
...
const ItemNext = ({ onPageChange }) => (
  <button onClick={onPageChange} type='button' className='w-full p-4 text-base rounded-r-xl bg-primary-900 hover:bg-primary-400'>
    <svg width='9' fill='currentColor' height='8' className='' viewBox='0 0 1792 1792' xmlns='http://www.w3.org/2000/svg'>
...
const Item = ({ active, onPageChange, children }) => {
  const className = clsx('w-full px-4 py-2 text-base bg-primary-900 hover:bg-primary-400', {
